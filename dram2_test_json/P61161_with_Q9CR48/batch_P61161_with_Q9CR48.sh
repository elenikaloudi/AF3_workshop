#!/bin/bash
#SBATCH --job-name=P61161_with_Q9CR48
...
#SBATCH --output="P61161_with_Q9CR48_%j.log"
#SBATCH --error="P61161_with_Q9CR48_%j.err"
...
export AF3_INPUT_DIR=/home/s4178858/data1/alphafold/AFSJson/dram2_test/P61161_with_Q9CR48/
export AF3_OUTPUT_DIR=/home/s4178858/data1/alphafold/output_dram2_test/P61161_with_Q9CR48
