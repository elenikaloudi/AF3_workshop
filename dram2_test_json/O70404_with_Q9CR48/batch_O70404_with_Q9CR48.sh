#!/bin/bash
#SBATCH --job-name=O70404_with_Q9CR48
...
#SBATCH --output="O70404_with_Q9CR48_%j.log"
#SBATCH --error="O70404_with_Q9CR48_%j.err"
...
export AF3_INPUT_DIR=/home/s4178858/data1/alphafold/AFSJson/dram2_test/O70404_with_Q9CR48/
export AF3_OUTPUT_DIR=/home/s4178858/data1/alphafold/output_dram2_test/O70404_with_Q9CR48
